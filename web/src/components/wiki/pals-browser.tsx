...
export function PalsBrowser() {
  ...
  useEffect(() => {
    void loadWikiData("elements")
      .then(setElements)
      .catch(() => {});
    void loadWikiData("work-suitability")
      .then(setWork)
      .catch(() => {});
  }, []);
  ...
  return (
    <WikiBrowser
      ...
      keyOfAction={(pal) => pal.id}
      matchesAction={(pal, query) =>
              ...
              <>
                ...
                {pal.elements.map((element) => {
                  ...
                  return (
                    ...
                    >
                      <WikiIcon icon={data?.icon} alt="" className="size-3.5" />
                      {data?.name ?? element}
                    </span>
                  );
                })}
